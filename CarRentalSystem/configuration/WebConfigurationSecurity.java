package com.carrentalapp.CarRentalSystem.configuration;
...
public class WebConfigurationSecurity {
    ...
    @Autowired
    public WebConfigurationSecurity(UserService userService, JwtAuthenticationFilter jwtAuthenticationFilter) {
